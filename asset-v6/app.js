...
var app = new function () {
    this.name = "Evadare", this.version = "1", this.date = "2022", this.folder = "asset-v6/", this.looptime = 6857, this.bpm = 140, this.totalframe = 342, this.nbpolo = 7, this.nbloopbonus = 6, this.bonusloopA = !0, this.bonusendloopA = !0, this.recmaxloop = 80, this.recminloop = 3, this.recmintime = Math.round(this.looptime / 1e3) * this.recminloop, this.spritepolo = "polo-sprite.png", this.spritepicto = "game-picto.png", this.colBck = "#070314", this.col0 = "#68388e", this.col1 = "#542a82", this.col2 = "#401e72", this.col3 = "#231144", this.col4 = "#210534", this.animearray = [{
        name: "1_lanturi",
        color: "68388e",
        uniqsnd: !1
    }, {
